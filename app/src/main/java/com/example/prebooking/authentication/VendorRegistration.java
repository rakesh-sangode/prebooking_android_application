...
public class VendorRegistration extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            String[] type = new String[] { "Book", "Buy", "Appointment"};
            ...
            autoCompleteTextView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Toast.makeText(VendorRegistration.this, autoCompleteTextView.getText().toString(), Toast.LENGTH_SHORT).show();
                }
            });
            ...
            submitButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (selectedState.equals("Select Your State")) {
                        Toast.makeText(VendorRegistration.this, "Please select your state from the list", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(VendorRegistration.this, "Please select your district from the list", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(VendorRegistration.this, "Selected State: "+selectedState+"\nSelected District: "+selectedDistrict, Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
